...
export interface AppRoute {
    path: string;
    title: string;
    kind: 'welcome' | 'placeholder';
    description?: string;
}

const routes: AppRoute[] = [
    { path: '/', title: '工作台', kind: 'welcome' },
    { path: '/users', title: '用户管理', kind: 'placeholder', description: '管理平台注册用户及账号状态。' },
    ...
    { path: '/access/admins', title: '管理员', kind: 'placeholder', description: '维护后台管理员账号和状态。' },
    { path: '/access/roles', title: '角色', kind: 'placeholder', description: '配置管理端角色与权限范围。' },
    { path: '/access/permissions', title: '权限', kind: 'placeholder', description: '维护权限代码和资源定义。' },
];
